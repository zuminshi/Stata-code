...
{p2colset 5 12 16 2}{...}
{p2col :{hi:myreg2a} {hline 2}}Table 2 in epidemiological journal{p_end}
{p2colreset}{...}


{title:Syntax}
{p 8 16 2}{cmd:myreg2a}, dp({it:decimal points}) ci({it:symbom for CI}) 
...
It combines regression results for all variables from multiple models into one Table.
...
{tab}{cmd:. myreg2a, dp(2) ci(-)}
{tab}{cmd:. putdocx save mytable2.docx,replace}
{tab}{cmd:. myreg2a, dp(2) ci(", ")}
{tab}{cmd:. myreg2a, dp(2) ci(" to ")}
